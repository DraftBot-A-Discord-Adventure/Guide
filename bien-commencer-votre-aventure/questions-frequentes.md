...
YES ! The invite link is on the website ([http://crownicles.com/](http://crownicles.com/)) or in the **#👑-bienvenue** channel or in a pinned message on the **#🗣-général** channel on the official discord server. A simple method is to click the link below :
