...
{% hint style="success" %}
Le processus de traduction d'évènements est le même que celui de rédaction : il vous suffit de suivre les mêmes étapes mais de prendre le rôle "traducteur" et d'aller sur le [site](https://translate.draftbot.com) prévu à cet effet.
{% endhint %}
