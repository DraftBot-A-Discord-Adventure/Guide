...
La commande `!topguilde` a été supprimée et sera réintroduite dans une version future sous le nom de [`!topserver`](../notions-avancees/monter-dans-les-classements.md) (avant de disparaître définitivement).
