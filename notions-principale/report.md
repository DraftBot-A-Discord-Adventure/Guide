...
Le temps indiqué entre parenthèses est le temps de voyage pour parvenir jusqu'au lieu, un point d'interrogation signifie que le temps est inconnu. Dans 15% des cas, le bot choisit automatiquement la destination du joueur.
