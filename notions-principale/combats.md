...
| Action                                                                                     | Description                                                                                                                                                                                                                                 |
| ------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| :crossed_swords: Attaque simple                                                            | Attaque classique, les chances de réussite et les dégâts sont moyens.                                                                                                                                                                       |
...
Dès lors que :zap: l'énergie de l'un des adversaire tombe à 0, le combat s'arrête. Le joueur encore debout remporte le combat et gagnes des :medal: points de classement.
...
Un combat peut aussi se terminer sur une égalité si ce dernier atteint les 25 tours consécutifs ou si les deux combattants arrivent à court d'énergie durant le même tour.
 ...
 Une fois un combat terminé, vous devrez attendre un certain temps avant de récupérer l'énergie :zap: que vous avez perdu.
